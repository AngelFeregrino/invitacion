          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            >
              <div className="relative group">
                ...
                {/* Badge on Photo */}
                <div className="absolute -bottom-3 -right-2 clay-pill px-4 py-1.5 bg-white/95 text-pink-950 font-bold text-xs flex items-center gap-1.5 shadow-md border border-pink-300">
            ...
            <div className="md:col-span-7 flex flex-col text-left">
              <div className="flex items-center gap-2 mb-3">
                <Quote className="w-8 h-8 text-pink-500/70 rotate-180" />
                <span className="text-xs uppercase tracking-[0.25em] text-pink-800 font-bold">
                  Palabras de la festejada
                </span>
              </div>

              <h3 className="font-serif-luxury text-2xl sm:text-3xl font-bold text-pink-950 mb-4 leading-snug">
                Un mensaje con todo mi cariño
              </h3>
              ...
              <div className="space-y-4 text-stone-700 font-serif-luxury text-lg sm:text-xl leading-relaxed italic">
                ...
                <p>
                  &ldquo;Hoy, al dar gracias a Dios por permitirme llegar a mis <strong className="text-pink-900 not-italic font-bold">60 años</strong> llenos de bendiciones, deseo que me acompañen para celebrar juntos este momento tan especial.&rdquo;
                </p>
                <p>
              ...
              {/* Signature Block */}
              <div className="mt-8 pt-4 border-t border-pink-200/60 flex flex-col items-end">
                ...
                <div className="font-signature text-4xl sm:text-5xl text-pink-800 font-normal">
                  Lety Feregrino
                </div>
              </div>
            </div>
